    ...
    <div className="runs-list-page">
      <div className="runs-list-toolbar">
        ...
        <p className="runs-list-subtitle">
          Журнал запусков в этом браузере — бэкенд не хранит общий список запусков, каждая строка
      ...
      {history.length === 0 ? (
        <div className="runs-list-empty">
          Пока ничего не запускалось. Запустите сценарий из списка или редактора — запуск появится
